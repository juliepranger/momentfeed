...
mf.services.API.prototype.getInstagramPhotos = function(token) {
  ...
  //    because of CORS.
  return this.$http.jsonp(this.$sce.trustAsResourceUrl('https://api.instagram.com/v1/users/261952381/media/recent/?access_token=' + token), {jsonpCallbackParam: 'callback'});
